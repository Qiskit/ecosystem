...
def test_O01(member):
    if not member.license and not member.github:  # probably too early, it is a new submission
    ...
    if member.license:
        ...
        assert False, "No license could be found. Populate 'member.license' as soon as possible."