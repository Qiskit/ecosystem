...
| [Quantum-enhanced-variational-autoencoder](https://github.com/Anantha-Rao12/Quantum-enhanced-variational-autoencoder) | - This is a submission for the Qiskit Ecosystem. - The project is the source code for building and running a hybrid quantum-classical neural network for generative modeling. - The code is a qiskit implementation of a quantum-enhanced variational autoencoder (QeVAE). - The project is based on the research paper "Learning hard distributions with quantum-enhanced Variational Autoencoders" by Rao et al. (https://arxiv.org/abs/2305.01592). <br/>  ![core](https://img.shields.io/badge/paper implementation-gray.svg)  <br/> |
