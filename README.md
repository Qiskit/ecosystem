...
To join the ecosystem, your project must:
  ...
  - [`[000]`](qisk.it/ecosystem-checkups#000) Build on, interface with, or extend the [Qiskit SDK](https://github.com/Qiskit/qiskit) in a meaningful way. 
  - [`[Q20]`](qisk.it/ecosystem-checkups#Q20) Be compatible with the Qiskit SDK v2.0 (or newer).
  - [`[001]`](qisk.it/ecosystem-checkups#001) Have an [OSI-approved](https://opensource.org/license?categories=popular-strong-community) open-source license (preferably Apache 2.0 or MIT).
  - [`[COC]`](qisk.it/ecosystem-checkups#COC)Adhere to our [code of conduct](./CODE_OF_CONDUCT.md) (you can enforce your own code of conduct in addition to this).
  - [`[G00]`](qisk.it/ecosystem-checkups#G00) Have a clear support expectation and, if actively maintained, show signs of that activity.
  - [`[020]`](qisk.it/ecosystem-checkups#020) New projects should be compatible with the [V2 primitives](https://docs.quantum.ibm.com/migration-guides/v2-primitives).
...
Daily, [a GitHub Action](.github/workflows/daily-update.yml) runs to update member stats and commits directly into main. [![Daily | Update member data](https://github.com/Qiskit/ecosystem/actions/workflows/daily-update.yml/badge.svg?branch=main)](https://github.com/Qiskit/ecosystem/actions/workflows/daily-update.yml)
